...
面向消费者的智能消费决策智能体。本仓库公开代码与工程配置;内部设计文档(ADR、规格书、handoff)仅保留在本地,不随仓库发布。

当前进度:P0-02 四进程健康纵向链路与 P0-03 首个合成决策纵向链路(Web → API → Orchestrator → Fake AgentRuntime → Decision)已完成并验收。
...
- Web 决策页面:<http://127.0.0.1:3000>(固定合成需求示例,不访问真实商品或价格)
